...
function offers(e, t, r) {
    "use strict";
    var n, o, i, a;
    (a = document.querySelector(".offers-tab")) && (a.querySelectorAll(".offers-tablinks").forEach(function(e) {
        ...
        $(".offer-image").each(function() {
            ...
            $.get(e, function(e) {
                e = $(e).find("svg");
                void 0 !== r && (e = e.attr("id", r)),
                    e = (e = void 0 !== n ? e.attr("class", n + " replaced-svg") : e).removeAttr("xmlns:a"),
                    t.replaceWith(e)
            }, "xml")
        }),
        ...
        document.querySelectorAll(".tabcontent-item").forEach(function(t) {
            t.addEventListener("click", function(e) {
                ...
                return "function" == typeof e.onclick && e.onclick.apply(e),
                    window.location = e.href, !1
            })
        })),
    document.addEventListener("DOMContentLoaded", function() {
        var r, n, e = [].slice.call(document.querySelectorAll("img.lazy")),
